...
public class TestSequential {
  public static void main(String[] args) throws InterruptedException, ExecutionException {
    ...
    WorkerWrapper<String, String> workerWrapper2 =
      new WorkerWrapper.Builder<String, String>().worker(w2).callback(w2).param("2").allowInterrupt(true).build();

    WorkerWrapper<String, String> workerWrapper1 = new WorkerWrapper.Builder<String, String>().worker(w1).callback(w1)
      .param("1").allowInterrupt(true).next(workerWrapper2).build();
  ...
  private static void testGroupTimeout(WorkerWrapper<String, String> workerWrapper)
    ...
    System.out.println("e-" + SystemClock.now());
    System.err.println("cost-" + (SystemClock.now() - now));
